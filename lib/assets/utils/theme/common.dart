...
const horizontalMargin40 = SizedBox(width: 40.0);
...
const verticalMargin100 = SizedBox(height: 100.0);
...
const borderRadiusOnlyLeft10 = BorderRadius.only(
    topLeft: Radius.circular(10), bottomLeft: Radius.circular(10));

// TextStyle
extension TexThemeExtensions on TextTheme {
  ...
  TextStyle get textNumberExperience => TextStyle(
        color: PortfolioColors.colorWhite,
        fontFamily: 'Nunito',
        fontSize: 70.0,
      );

  TextStyle get textExperience => TextStyle(
        color: PortfolioColors.colorWhite,
        fontSize: 20,
        fontFamily: 'Nunito',
      );
  ...
  TextStyle get title => TextStyle(
        ...
        decorationColor: PortfolioColors.colorWhite,
      );
  ...
  TextStyle get subtitle_01 => TextStyle(
        color: PortfolioColors.colorWhite,
        fontWeight: FontWeight.bold,
        fontFamily: 'Shadow',
        fontSize: 26.0,
  ...
  TextStyle get subtitle_02 => TextStyle(
        color: PortfolioColors.colorWhite,
        fontWeight: FontWeight.normal,
        fontFamily: 'Nunito',
        fontSize: 20.0,
  ...
  TextStyle get subtitle_03 => TextStyle(
        color: PortfolioColors.colorWhite,
        fontWeight: FontWeight.normal,
        fontFamily: 'Nunito',
        fontSize: 15.0,
